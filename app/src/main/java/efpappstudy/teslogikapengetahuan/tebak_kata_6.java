...
public class tebak_kata_6 extends Activity implements View.OnClickListener{
    ...
    int indeks = 0;
    int unlock6,allsounds;
    String [] pertanyaan = {"Ilmu yang mempelajari kehidupan dan kebudayaan zaman kuno", "Samudera terbesar di dunia", "Senjata tradisional khas Aceh",
            "Siaran (pengiriman) suara atau bunyi melalui udara", "Alat untuk mengukur kecepatan angin", "Galat (sinonim)", "Zat yang penting bagi tubuh manusia untuk pertumbuhan dan perkembangan",
            "Lapisan luar atau permukaan matahari", "Tabel yang berisi tampilan unsur-unsur kimia", "Sebutan gaya bahasa"};
    String [] jawaban = {"ARKEOLOGI", "PASIFIK", "RENCONG", "RADIO", "ANEMOMETER", "KELIRU", "VITAMIN", "FOTOSFER", "PERIODIK", "MAJAS"};
    String [] jumlahhuruf = {"9 Huruf", "7 Huruf", "7 Huruf", "5 Huruf", "10 Huruf", "6 Huruf", "7 Huruf", "8 Huruf", "8 Huruf", "5 Huruf"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tebak_kata_6);
        ...
        txthuruf = (TextView)findViewById(R.id.hurufTxt6);
        tamat = (RelativeLayout)findViewById(R.id.rldone6);
        txthuruf.setText(jumlahhuruf[0]);
        jumlahsoal = (TextView)findViewById(R.id.persoalan6);
        slmt = (TextView)findViewById(R.id.txtSelamat6);
        ...
        soal = (TextView) findViewById(R.id.question6);
        soal.setText(pertanyaan[0]);
        benarsalah = (ImageView) findViewById(R.id.benarsalahimg6);
        horeee = MediaPlayer.create(this, R.raw.applause);
        waktumundur = (TextView)findViewById(R.id.timertxt6);
        telolet = MediaPlayer.create(this, R.raw.waktuhabis);
        txt1 = (TextView)findViewById(R.id.textView333333);
        Button home = (Button)findViewById(R.id.home_6);
        isi = (EditText)findViewById(R.id.jawabTxt6);
        lanjut = (Button)findViewById(R.id.okbtn6);
        AdView adView = (AdView)findViewById(R.id.adView14);
        AdRequest adRequest = new AdRequest.Builder().build();
        adView.loadAd(adRequest);
        jawab = (Button)findViewById(R.id.jawabBtn6);
        jawab.setOnClickListener(this);
        Intent level6 = getIntent();
        allsounds = level6.getIntExtra("Efeksuara", 0);
        if (allsounds == 1){
        ...
        waktu2 = new CountDownTimer(2000, 1000) {
            ...
            @Override
            public void onFinish() {
                Intent un6 = new Intent(tebak_kata_6.this, level_tebak_kata.class);
                un6.putExtra("Efeksuara", allsounds);
                startActivity(un6);
                finish();
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new AlertDialog.Builder(tebak_kata_6.this)
