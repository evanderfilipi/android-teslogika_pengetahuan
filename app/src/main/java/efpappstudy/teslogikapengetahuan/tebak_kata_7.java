...
public class tebak_kata_7 extends Activity implements View.OnClickListener{
    ...
    int indeks = 0;
    int unlock7,allsounds;
    String [] pertanyaan = {"Alat untuk mengukur kerapatan zat cair", "Ilmu matematika yang mempelajari hubungan antara sisi dan sudut segitiga", "Cerita yang menggambarkan perilaku manusia (diperankan oleh hewan)",
            "Kata yang memiliki makna berbeda, tetapi lafal dan ejaannya sama", "Ahli (sinonim)", "Tidak menurut hukum atau tidak sah", "Skala dalam musik dengan 5 not per oktaf",
            "Protein sel darah merah yang berfungsi sebagai pengangkut oksigen", "Bangunan atau tempat yang mempunyai nilai sejarah", "Logam campuran yang mengandung tembaga dan timah putih"};
    String [] jawaban = {"DENSIMETER", "TRIGONOMETRI", "FABEL", "HOMONIM", "PAKAR", "ILEGAL", "PENTATONIK", "HEMOGLOBIN", "MONUMEN", "PERUNGGU"};
    String [] jumlahhuruf = {"10 Huruf", "12 Huruf", "5 Huruf", "7 Huruf", "5 Huruf", "6 Huruf", "10 Huruf", "10 Huruf", "7 Huruf", "8 Huruf"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tebak_kata_7);
        ...
        txthuruf = (TextView)findViewById(R.id.hurufTxt7);
        tamat = (RelativeLayout)findViewById(R.id.rldone7);
        txthuruf.setText(jumlahhuruf[0]);
        jumlahsoal = (TextView)findViewById(R.id.persoalan7);
        slmt = (TextView)findViewById(R.id.txtSelamat7);
        ...
        soal = (TextView) findViewById(R.id.question7);
        soal.setText(pertanyaan[0]);
        benarsalah = (ImageView) findViewById(R.id.benarsalahimg7);
        horeee = MediaPlayer.create(this, R.raw.applause);
        waktumundur = (TextView)findViewById(R.id.timertxt7);
        telolet = MediaPlayer.create(this, R.raw.waktuhabis);
        txt1 = (TextView)findViewById(R.id.textView3333333);
        Button home = (Button)findViewById(R.id.home_7);
        isi = (EditText)findViewById(R.id.jawabTxt7);
        lanjut = (Button)findViewById(R.id.okbtn7);
        AdView adView = (AdView)findViewById(R.id.adView15);
        AdRequest adRequest = new AdRequest.Builder().build();
        adView.loadAd(adRequest);
        jawab = (Button)findViewById(R.id.jawabBtn7);
        ...
        waktu2 = new CountDownTimer(2000, 1000) {
            ...
            @Override
            public void onFinish() {
                Intent un7 = new Intent(tebak_kata_7.this, level_tebak_kata.class);
                un7.putExtra("Efeksuara", allsounds);
                startActivity(un7);
                finish();
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new AlertDialog.Builder(tebak_kata_7.this)
