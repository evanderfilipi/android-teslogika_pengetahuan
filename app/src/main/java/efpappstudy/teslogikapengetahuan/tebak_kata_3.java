...
public class tebak_kata_3 extends Activity implements View.OnClickListener {
    ...
    int indeks = 0;
    int unlock3, allsounds;
    String [] pertanyaan = {"Planet ke-7 dari Matahari", "Lukisan pada kulit tubuh", "Pembuluh nadi yang besar", "Perairan atau laut sempit yang terletak diantara 2 pulau",
            "Panci bersusun dan bertutup untuk tempat makanan", "Sikap saling menghormati perbedaan antar individu atau kelompok", "Tidak bisa tidur",
            "Sebutan hewan pemakan daging", "Jinak (antonim)", "Bentuk pemerintahan yang dipimpin oleh seorang Presiden"};
    String [] jawaban = {"URANUS", "TATO", "AORTA", "SELAT", "RANTANG", "TOLERANSI", "INSOMNIA", "KARNIVORA", "BUAS", "REPUBLIK"};
    String [] jumlahhuruf = {"6 Huruf", "4 Huruf", "5 Huruf", "5 Huruf", "7 Huruf", "9 Huruf", "8 Huruf", "9 Huruf", "4 Huruf", "8 Huruf"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tebak_kata_3);
        ...
        txthuruf = (TextView)findViewById(R.id.hurufTxt3);
        tamat = (RelativeLayout)findViewById(R.id.rldone3);
        txthuruf.setText(jumlahhuruf[0]);
        jumlahsoal = (TextView)findViewById(R.id.persoalan3);
        slmt = (TextView)findViewById(R.id.txtSelamat3);
        ...
        soal = (TextView) findViewById(R.id.question3);
        soal.setText(pertanyaan[0]);
        benarsalah = (ImageView) findViewById(R.id.benarsalahimg3);
        horeee = MediaPlayer.create(this, R.raw.applause);
        waktumundur = (TextView)findViewById(R.id.timertxt3);
        telolet = MediaPlayer.create(this, R.raw.waktuhabis);
        txt1 = (TextView)findViewById(R.id.textView333);
        Button home = (Button)findViewById(R.id.home_3);
        isi = (EditText)findViewById(R.id.jawabTxt3);
        lanjut = (Button)findViewById(R.id.okbtn3);
        AdView adView = (AdView)findViewById(R.id.adView11);
        AdRequest adRequest = new AdRequest.Builder().build();
        adView.loadAd(adRequest);
        jawab = (Button)findViewById(R.id.jawabBtn3);
        jawab.setOnClickListener(this);
        Intent level3 = getIntent();
        allsounds = level3.getIntExtra("Efeksuara", 0);
        if (allsounds == 1){
        ...
        waktu2 = new CountDownTimer(2000, 1000) {
            ...
            @Override
            public void onFinish() {
                Intent un3 = new Intent(tebak_kata_3.this, level_tebak_kata.class);
                un3.putExtra("Efeksuara", allsounds);
                startActivity(un3);
                finish();
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new AlertDialog.Builder(tebak_kata_3.this)
