...
public class tebak_kata_4 extends Activity implements View.OnClickListener{
    ...
    int indeks = 0;
    int unlock4,allsounds;
    String [] pertanyaan = {"Tempat berakhirnya aliran sungai di laut", "Takaran pada obat", "Lapisan kulit tipis pada tubuh",
            "Kelompok Negara Asia Tenggara", "Zat minyak yang melekat pada daging", "Nama satuan Suhu dalam sistem Satuan Internasional (SI)",
            "Membaca huruf demi huruf", "Gasal (sinonim)", "Peristiwa pada 16 Agustus 1945", "Tinggi rendahnya bunyi dalam lagu atau musik"};
    String [] jawaban = {"MUARA", "DOSIS", "ARI", "ASEAN", "LEMAK", "KELVIN", "EJA", "GENAP", "RENGASDENGKLOK", "NADA"};
    String [] jumlahhuruf = {"5 Huruf", "5 Huruf", "3 Huruf", "5 Huruf", "5 Huruf", "6 Huruf", "3 Huruf", "5 Huruf", "14 Huruf", "4 Huruf"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tebak_kata_4);
        ...
        txthuruf = (TextView)findViewById(R.id.hurufTxt4);
        tamat = (RelativeLayout)findViewById(R.id.rldone4);
        txthuruf.setText(jumlahhuruf[0]);
        jumlahsoal = (TextView)findViewById(R.id.persoalan4);
        slmt = (TextView)findViewById(R.id.txtSelamat4);
        ...
        soal = (TextView) findViewById(R.id.question4);
        soal.setText(pertanyaan[0]);
        benarsalah = (ImageView) findViewById(R.id.benarsalahimg4);
        horeee = MediaPlayer.create(this, R.raw.applause);
        waktumundur = (TextView)findViewById(R.id.timertxt4);
        telolet = MediaPlayer.create(this, R.raw.waktuhabis);
        txt1 = (TextView)findViewById(R.id.textView3333);
        Button home = (Button)findViewById(R.id.home_4);
        isi = (EditText)findViewById(R.id.jawabTxt4);
        lanjut = (Button)findViewById(R.id.okbtn4);
        AdView adView = (AdView)findViewById(R.id.adView12);
        AdRequest adRequest = new AdRequest.Builder().build();
        adView.loadAd(adRequest);
        jawab = (Button)findViewById(R.id.jawabBtn4);
        jawab.setOnClickListener(this);
        Intent level4 = getIntent();
        allsounds = level4.getIntExtra("Efeksuara", 0);
        if (allsounds == 1){
        ...
        waktu2 = new CountDownTimer(2000, 1000) {
            ...
            @Override
            public void onFinish() {
                Intent un4 = new Intent(tebak_kata_4.this, level_tebak_kata.class);
                un4.putExtra("Efeksuara", allsounds);
                startActivity(un4);
                finish();
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new AlertDialog.Builder(tebak_kata_4.this)
